...
export default function AdminLayout() {
  ...
  // Cargamos usuario del localStorage
  ...
  // Función Salir: Solo borra el localstorage
  const handleLogout = () => {
  ...
  return (
    // ESTRUCTURA BÁSICA FLEXBOX: SIN CAPAS EXTRAS
    <div
    ...
    >
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        {/* HEADER */}
        <header className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shadow-sm z-20 relative">
          {/* BUSCADOR */}
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-slate-50 relative z-10">
          {/* El Outlet es donde se renderizan tus páginas (Dashboard, Productos, etc) */}
          <Outlet />
        </main>
      </div>
    </div>
